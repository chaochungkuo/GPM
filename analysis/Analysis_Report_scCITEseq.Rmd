...
```
wget -r --user USERNAME --password PASSWORD https://genomics.rwth-aachen.de/data/220311_Brandt_Berres_MiedIII_scCITEseq/compressed_tar/_1_Raw_data.tar.gz

wget -r --user USERNAME --password PASSWORD https://genomics.rwth-aachen.de/data/220311_Brandt_Berres_MiedIII_scCITEseq/compressed_tar/_2_Processed_data.tar.gz
```
