...
DIR_count_published <- "EXPORT_URL/PROJECT_PROJECT_NAME/2_Processed_data/nfcore_scRNAseq/results/cellranger/count/"
DIR_save <- "EXPORT_URL/PROJECT_PROJECT_NAME/3_Reports/analysis/scRNAseq_pipeline/save/"
```
...
FASTQ files were generated using cellranger mkfastq (10x Genomics). The generated FASTQ files are analyzed by nfcore/scrnaseq pipeline (version 4.0.0) with cellranger aligner. This report was generated using custom scripts in R version 4.3.3.
...
### [QC of scRNA-seq](scRNAseq_pipeline/preprocessing/1_quality_control.html)
### [Normalization & Clustering of scRNA-seq](scRNAseq_pipeline/preprocessing/2_normalization.html)
### [Download save/adata.h5ad](`r DIR_save`)
