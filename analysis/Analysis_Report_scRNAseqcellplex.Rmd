...
DIR_multi_output_published <- "EXPORT_URL/PROJECT_PROJECT_NAME/2_Processed_data/results/"
```
...
for (i in 1:length(samples)) {
    if (i ==1){
        cells <- list.dirs(path = paste0(DIR_multi_output, samples[i]), full.names = F, recursive = F)
