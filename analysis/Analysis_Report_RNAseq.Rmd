...
4. [Compressed files for download](EXPORT_URL/PROJECT_NAME/compressed_tar/):
...
```
wget -r -nH -np -nd -P --user USERNAME --password PASSWORD -A '*.tar' EXPORT_URL/PROJECT_NAME/compressed_tar/ -P PROJECT_NAME 
```
