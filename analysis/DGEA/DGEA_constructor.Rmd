...
render_html <- TRUE
# Paths
DIR_base <- "/data/projects/231129_Moellmann_Lehrke_MedI_mRNAseq/"
DIR_analysis <- paste0(DIR_base, "analysis/")
DIR_DGEA <- paste0(DIR_analysis, "DGEA/")
setwd(DIR_DGEA)
DIR_salmon <- paste0(DIR_base, "nfcore_RNAseq/results/star_salmon/")
FILE_tx2gene <- paste0(DIR_base, "nfcore_RNAseq/results/star_salmon/salmon_tx2gene.tsv")
# Load functions
...
spikein_ERCC <- FALSE
# Organism
organism <- "hsapiens" # hsapiens mmusculus rnorvegicus sscrofa
# Parameters
Fig_width <- 600
Fig_height <- 400
...
save(DIR_base, DIR_analysis, DIR_DGEA, DIR_salmon, FILE_tx2gene, 
     countsFromAbundance, lengthcorrection, spikein_ERCC,
     organism, 
