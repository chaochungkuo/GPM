...
```{r saving_presubset_obj, echo=echo_param, results='hide', warning=FALSE, message=FALSE}
save_dir <- "OUTPUT"

# check if sub directory exists
if (!file.exists(save_dir)) {
  dir.create(file.path(QC_DIR, save_dir))
}
saveRDS(object = seurat_obj, file = file.path(QC_DIR, save_dir, file_TAG, ".RDS"))
```
...
```{r saving_postsubset_obj, echo=echo_param, results='hide', warning=FALSE, message=FALSE, eval = subset}
save_dir <- "OUTPUT"
...
saveRDS(object = seurat_obj, file = file.path(QC_DIR, save_dir, file_TAG, "_subseted.RDS"))
```
