...
```{r FILE_TAG-factory, echo=echo_param, results='hide', warning=FALSE, message=FALSE}
...
```{r FILE_TAG-seurat_obj_creation, echo=echo_param, results='hide', warning=FALSE, message=FALSE}
...
## Violin Plot
```{r FILE_TAG-violin_plot, echo=echo_param, results='asis', warning=FALSE, message=FALSE, dpi=300, fig.width=8, fig.height=6, fig.format='png'}
VlnPlot(seurat_obj, features = c("nFeature_RNA", "nCount_RNA", "percent.mito", "percent.ribo"), ncol = 2)
```

```{r FILE_TAG-outlier calculation, echo= echo_param, results="hide", warning=FALSE, message=FALSE}
...
```{r FILE_TAG-histograms, echo=echo_param, results='asis', warning=FALSE, message=FALSE, dpi=300, fig.width=8, fig.height=6, fig.format='png', }
...
```{r FILE_TAG-saving_presubset_obj, echo=echo_param, results='hide', warning=FALSE, message=FALSE}
save_dir <- "OUTPUT"
...
```{r FILE_TAG-adding mask, echo=echo_param, results='hide', warning=FALSE, message=FALSE}
...
```{r FILE_TAG-scatter_plots, echo=echo_param, results='asis', warning=FALSE, message=FALSE, dpi=300, fig.width=10, fig.height=4, fig.format='png'}
...
```{r FILE_TAG-default_analysis_pipeline_before, echo=echo_param, results='hide', warning=FALSE, message=FALSE}
...
```{r FILE_TAG-dim_reductionplot, echo=echo_param, results='asis', warning=FALSE, message=FALSE, dpi=300, fig.width=4, fig.height=3, fig.format='png'}
...
```{r FILE_TAG-dim_red_umap, echo=echo_param, results='asis', warning=FALSE, message=FALSE, dpi=300, fig.width=4, fig.height=3, fig.format='png'}
...
```{r FILE_TAG-featureplot_nfeatures, echo=echo_param, results='asis', warning=FALSE, message=FALSE, dpi=300, fig.width=4, fig.height=3, fig.format='png'}
...
```{r FILE_TAG-featureplot_ncounts, echo=echo_param, results='asis', warning=FALSE, message=FALSE, dpi=300, fig.width=4, fig.height=3, fig.format='png'}
...
```{r FILE_TAG-featureplot_percent.mito, echo=echo_param, results='asis', warning=FALSE, message=FALSE, dpi=300, fig.width=4, fig.height=3, fig.format='png'}
...
```{r FILE_TAG-subset_followed_by_analysis, echo=echo_param, results='hide', warning=FALSE, message=FALSE, eval= subset}
...
```{r FILE_TAG-dim_reductionplot_after, eval=subset ,echo=echo_param, results='asis', warning=FALSE, message=FALSE, dpi=300, fig.width=4, fig.height=3, fig.format='png'}
DimPlot(seurat_obj, reduction = "pca", group.by = "orig.ident") +
  theme_classic() +
  theme(text = element_text(size = 10))
```
...
```{r FILE_TAG-dim_red_umap_after, eval=subset, echo=echo_param, results='asis', warning=FALSE, message=FALSE, dpi=300, fig.width=4, fig.height=3, fig.format='png'}
DimPlot(seurat_obj, reduction = "umap", group.by = "orig.ident") +
  theme_classic() +
  theme(text = element_text(size = 10))
```
...
```{r FILE_TAG-featureplot_nfeatures_after, eval=subset, echo=echo_param, results='asis', warning=FALSE, message=FALSE, dpi=300, fig.width=4, fig.height=3, fig.format='png'}
FeaturePlot(object = seurat_obj, features = "nFeature_RNA") +
  theme_classic() +
  theme(text = element_text(size = 10))
```
...
```{r FILE_TAG-featureplot_ncounts_after, eval=subset, echo=echo_param, results='asis', warning=FALSE, message=FALSE, dpi=300, fig.width=4, fig.height=3, fig.format='png'}
FeaturePlot(object = seurat_obj, features = "nCount_RNA") +
  theme_classic() +
  theme(text = element_text(size = 10))
```
...
```{r FILE_TAG-featureplot_percent.mito_after, eval=subset, echo=echo_param, results='asis', warning=FALSE, message=FALSE, dpi=300, fig.width=4, fig.height=3, fig.format='png'}
FeaturePlot(object = seurat_obj, features = "percent.mito") +
  theme_classic() +
  theme(text = element_text(size = 10))
```
...
```{r FILE_TAG-saving_postsubset_obj, echo=echo_param, results='hide', warning=FALSE, message=FALSE, eval = subset}
save_dir <- "OUTPUT"
...
```{r FILE_TAG-session info, echo=echo_param, results='markup', warning=FALSE, message=TRUE}
sessionInfo()
```
